# map1.py
from map_data.constants import BLACKISH_BROWN, CIRCLE_RADIUS, DARK_RED, SPACING
    ...
    def create_cities_and_routes(self, num_players):
        ...
        self.upgrade_cities.append(
            Upgrade(
                ...
                "Keys",
                Halle.x_pos,
                Halle.y_pos - UPGRADE_Y_AXIS_OFFSET,
                width=Halle.width,
                height=Halle.height - 30,
            )
        )
        self.upgrade_cities.append(
            Upgrade(
                ...
                "Privilege",
                Stade.x_pos,
                Stade.y_pos - UPGRADE_Y_AXIS_OFFSET,
                width=Stade.width,
                height=Stade.height - 30,
            )
        )
        self.upgrade_cities.append(
            Upgrade(
                ...
                "Book",
                Groningen.x_pos,
                Groningen.y_pos - UPGRADE_Y_AXIS_OFFSET,
                width=Groningen.width,
                height=Groningen.height - 30,
            )
        )
        self.upgrade_cities.append(
            Upgrade(
                ...
                "Actions",
                Gottingen.x_pos,
                Gottingen.y_pos - UPGRADE_Y_AXIS_OFFSET,
                width=Gottingen.width,
                height=Gottingen.height - 30,
            )
        )
        self.upgrade_cities.append(
            Upgrade(
                ...
                "Bank",
                Lubeck.x_pos,
                Lubeck.y_pos - UPGRADE_Y_AXIS_OFFSET,
                width=Lubeck.width,
                height=Lubeck.height - 30,
            )
        )
