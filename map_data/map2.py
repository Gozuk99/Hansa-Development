...
class Map2(Map):
    def __init__(self, rng=None):
        ...
        self.bonus_marker_positions = {
            ...
            ("BerlinColln", "Brandenburg"): (601, 836),
            ("Brandenburg", "Halle"): (399, 944),
            ("Halle", "Magdeburg"): (308, 1036),
    ...
    def create_cities_and_routes(self):
        ...
        self.upgrade_cities.append(
            Upgrade(
                ...
                "Keys",
                Dresden.x_pos,
                Dresden.y_pos - UPGRADE_Y_AXIS_OFFSET,
                width=Dresden.width,
                height=Dresden.height - 30,
            )
        )
        self.upgrade_cities.append(
            Upgrade(
                ...
                "Privilege",
                Magdeburg.x_pos,
                Magdeburg.y_pos - UPGRADE_Y_AXIS_OFFSET,
                width=Magdeburg.width,
                height=Magdeburg.height - 30,
            )
        )
        self.upgrade_cities.append(
            Upgrade(
                ...
                "Book",
                Breslau.x_pos,
                Breslau.y_pos - UPGRADE_Y_AXIS_OFFSET,
                width=Breslau.width,
                height=Breslau.height - 30,
            )
        )
        self.upgrade_cities.append(
            Upgrade(
                ...
                "Actions",
                Waren.x_pos,
                Waren.y_pos - UPGRADE_Y_AXIS_OFFSET,
                width=Waren.width / 2,
                height=Waren.height - 30,
            )
        )
        self.upgrade_cities.append(
            Upgrade(
        ...
        x_start_pos = (Konigsberg.x_pos + (Konigsberg.width / 2)) - (
        ...
        self.routes.append(
            Route([Mismar, Stralsund], 3, permanent_bm_type="MoveAny2", required_circles=2)
        )
        self.routes.append(
            Route([Stralsund, Malmo], 3, permanent_bm_type="+1Priv", required_circles=2)
        )
        self.routes.append(
            Route([Malmo, Visby], 3, permanent_bm_type="ClaimGreenCity", required_circles=1)
        )
        self.routes.append(
            Route(
                [Malmo, Danzig], 4, permanent_bm_type="Place2TradesmenFromRoute", required_circles=1
            )
        )
