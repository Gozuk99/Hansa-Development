# Hansa Teutonica Big Box Rulebook

> Reformatted from supplied rulebook text for project reference.
...
(Prestige Points Network: 1, 2, 2, 3, 4): At the end of the game, each trading post in your largest network earns you prestige points corresponding to the highest number showing (for details see section F Prestige Points for Network on page 7).

### Actions

[Actiones on your writing desk] (2, 3, 3, 4, 4, 5): This ability determines how many actions you have available each turn.

### Privilege

[Privilegium on your writing desk] (primum/lowest - white, minus/low - orange, maius/high - pink, maximum/highest - black): Developing this ability will expose additional colors that indicate which trading posts you can fill with your tradesmen. The trading post values increase from white to black (Important in case of ties – for details see Action E) Create 1 Trade Route on page 4).

### Book of Knowledge

[Liber Sophiae on your writing desk] (2, 3, 4, 5): This value indicates the number of tradesmen you can move with action D) Move your Tradesmen on the game board (for details see page 4).

### Bank

(3, 4, 7, C): This indicates how many of your tradesmen you can hire from the general stock to transfer them to your personal supply for the action A) Income (for details see page 4). “C” comes from the Latin cuncti and means “all.” If you have uncovered the C, you can use action A) to hire all of your tradesmen in the general stock and transfer them to your personal supply.
